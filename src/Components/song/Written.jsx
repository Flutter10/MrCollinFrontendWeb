...
const Written = () => {
  ...
  const imageData = [
    {
      image: cross1,
      title: "Created by:Ruben Dias",
      samples: "Lorem Ipsum is simply dummy text",
    },
    {
      image: cross2,
      title: "Created by:Ruben Dias",
                ...
                {imageData.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="image-overlay absolute inset-0 z-10">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-black/20 to-[#D9D9D9] backdrop-blur-lg"></div>                      {/* Content container with proper z-index */}
                      <div className="absolute bottom-0 p-2 left-0 right-0 flex justify-between items-center z-20">
                        ...
                        <button className=" bg-white bg-opacity-50 rounded-full p-2  hover:bg-opacity-75 transition-all duration-300"
