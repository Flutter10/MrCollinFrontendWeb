...
export default function Brand() {
  ...
  const services = [
    { title: "AI MUSIC PRODUCTION", video: video2 },
    { title: "AI SONG RECORDING", video: video1 },
    { title: "AI BRAND & MERCHANDISE", video: video3 },
    { title: "AI VIDEO PRODUCTION", video: video4 },
  ];
    ...
    <div ref={sectionRef} className="brand-section">
      <div className="brand-grid">
        ...
        {services.slice(2).map((service, index) => (
          <div key={index + 2} className="video-frame">
            <video autoPlay playsInline loop muted>
              <source src={service.video} type="video/mp4" />
            </video>
            <div className="video-overlay">
