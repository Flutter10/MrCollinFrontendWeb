...
const PresetCard = ({ icon, title, description, tags }) => {
...
const SignatureSound = () => {
  const presets = [
    {
      icon: pic1,
      title: "Universal",
      description: "Natural dynamic and tonal balancing",
      tags: ["Rock", "Pop", "Electronic", "Alternative"],
    },
    {
      icon: fire,
      title: "Fire",
      description: "Punchy lows and midrange clarity",
      tags: ["Trap", "Experimental", "Reggaeton"],
    },
    {
      icon: Clarity,
      title: "Clarity",
      description: "Polished highs without dynamic suppression",
      tags: ["R&B", "Classical", "Singer-songwriter"],
    },
    {
      icon: Tape,
      title: "Tape",
      description: "Warm saturation with analog dynamics",
      tags: ["Jazz", "Alternative", "Indie", "Rock"],
    },
    {
      icon: Natural,
      title: "Natural",
      description: "Classical dynamics and gentle enhancement",
      tags: ["Acoustic", "Jazz", "Singer-songwriter"],
    },
    {
      icon: Spatial,
      title: "Spatial",
      description: "Enhanced stereo field and enhanced stability",
      tags: ["Ambient", "Experimental", "Electronic"],
    },
    {
      icon: cinema,
      title: "Cinematic",
      description: "Minimal but uniform and harmonic distortion",
      tags: ["Soundtrack", "Orchestral", "Classical"],
    },
    {
      icon: punch,
      title: "Punch",
      description: "Energetic bass combined with balanced highs",
      tags: ["Trap", "Hip Hop", "R&B"],
    },
  ];
      ...
      <div className="max-w-full mx-auto">
        <h1 className="text-white text-2xl sm:text-4xl md:text-6xl font-['Orbitron'] mb-8 sm:mb-16 text-center">
          <p className="text-3xl sm:text-5xl">
            Make Your Music, With Your Signature Sound.
          </p>
        </h1>
